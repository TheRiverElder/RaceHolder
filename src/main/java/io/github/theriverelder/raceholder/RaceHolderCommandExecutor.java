...
import static io.github.theriverelder.raceholder.RaceHolder.RACE_MANAGER;
import static io.github.theriverelder.raceholder.Utils.toFixedString;

public class RaceHolderCommandExecutor implements CommandExecutor {
                ...
                case "plan": {
                    ...
                    switch (action) {
                        ...
                        case "add": {
                            ...
                            sender.sendMessage("已添加路径点：" + (race.getWaypoints().size() - 1) + toFixedString(waypoint));
                            break;
                        }
                        case "insert": {
